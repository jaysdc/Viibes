        ...
        >
            ...
            >
                ...
                <div className="flex flex-col w-full">
                        {isArtistSort ? (
                            <>
                                <span className={`font-bold truncate ${!isSongAvailable(song) ? 'text-gray-400' : !isSelected ? 'text-gray-900' : ''}`} style={{ fontSize: CONFIG.ROW_TITLE_SIZE, lineHeight: CONFIG.ROW_LINE_HEIGHT, color: isSelected && isSongAvailable(song) ? '#124c73' : undefined }}>{song.title}</span>
