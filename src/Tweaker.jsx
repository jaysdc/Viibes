            ...
            >
                ...
                <div className="flex-1 relative" style={{ height: TWEAKER_CONFIG.HEADER_BTN_HEIGHT }}>
                    ...
                    <button
                        ...
                        className={`w-full h-full ${is3DMode ? '' : 'rounded-full'} flex items-center justify-center gap-2 font-bold text-xs uppercase tracking-wider overflow-hidden relative`}
                        style={{
                            borderRadius: is3DMode ? '0.5rem' : undefined,
                ...
                <div className="relative flex-shrink-0" style={{ height: TWEAKER_CONFIG.HEADER_BTN_HEIGHT, width: TWEAKER_CONFIG.HEADER_BTN_HEIGHT }}>
                    ...
                    <button
                        ...
                        className={`w-full h-full ${is3DMode ? '' : 'rounded-full'} flex items-center justify-center overflow-hidden relative`}
                        style={{
                            borderRadius: is3DMode ? '0.5rem' : undefined,
