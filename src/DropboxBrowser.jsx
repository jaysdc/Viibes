                        ...
                        <div className="relative" style={{ flexShrink: 0, paddingLeft: CONFIG.HORIZONTAL_PADDING, paddingRight: CONFIG.HORIZONTAL_PADDING, paddingTop: '0.5rem', paddingBottom: '0.5rem' }}>
                            <div className="flex items-center gap-2" style={{ opacity: scanPhase === 'processing' ? 0 : 1 }}>
                                ...
                                <div className={`relative overflow-visible ${is3DMode ? '' : 'rounded-full'} flex-shrink-0`} style={{ height: UNIFIED_CONFIG.CAPSULE_HEIGHT, width: UNIFIED_CONFIG.CAPSULE_HEIGHT, borderRadius: is3DMode ? '0.5rem' : undefined }}>
                                    ...
                                    <button onClick={handleClose} disabled={!!closingButton || scanning} className={`relative z-10 w-full h-full ${is3DMode ? '' : 'rounded-full'} ${is3DMode ? '' : 'border border-gray-100'} shadow-sm font-bold text-sm flex items-center justify-center overflow-visible`} style={{ background: closingButton === 'close' ? 'transparent' : UNIFIED_CONFIG.CAPSULE_BG_INACTIVE, color: closingButton === 'close' ? 'white' : '#9ca3af', borderRadius: is3DMode ? '0.5rem' : undefined }}>
                                        <CylinderMask is3DMode={is3DMode} intensity={0.6} />
                                ...
                                <div className={`flex-1 relative overflow-visible ${is3DMode ? '' : 'rounded-full'}`} style={{ height: UNIFIED_CONFIG.CAPSULE_HEIGHT, borderRadius: is3DMode ? '0.5rem' : undefined }}>
                                    ...
                                    <button onClick={handleDisconnect} disabled={!!closingButton || scanning} className={`relative z-10 w-full h-full ${is3DMode ? '' : 'rounded-full'} ${is3DMode ? '' : 'border border-gray-100'} shadow-sm font-bold text-sm flex items-center justify-center gap-1 overflow-visible`} style={{ background: closingButton === 'disconnect' ? 'transparent' : UNIFIED_CONFIG.CAPSULE_BG_INACTIVE, color: closingButton === 'disconnect' ? 'white' : '#ef4444', borderRadius: is3DMode ? '0.5rem' : undefined }}>
                                        <CylinderMask is3DMode={is3DMode} intensity={0.6} />
